package com.absa.api.test;

import java.util.Properties;

import com.absa.api.constant.Constant;
import com.absa.api.util.Utility;
...
public class DogBreedApiTest {
	 ...
	 final static Logger logger = Logger.getLogger(DogBreedApiTest.class);
	    ...
	    ExtentReports extent = com.absa.api.utils.ExtentManager.getInstance();
